...
- `step_04_job_offer_analysis.ipynb`: Performs analysis on the processed data, including visualizations and insights.
...
1. Open the Jupyter notebooks in the following order:
   ...
   - Then `step_03_skill_extraction.ipynb`
   - Finally `step_04_job_offer_analysis.ipynb`
